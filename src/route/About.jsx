        ...
        <div /*className="flex gap-12 mt-4  "*/>
          ...
          <div className="flex flex-col md:flex-row lg:flex-row  md:gap-16 lg:gap-16 ">
            ...
            <p className="mt-3 font-medium text-[#09AB46] pl-10 md:pl-0 lg:pl-0 md:w-80 lg:w-80 font-poppins">
              At ARTISINIAN, we are passionate about connecting talented
              artisans with a global audience. Our platform is dedicated to
              showcasing unique, handcrafted products that tell a story of

...
export default function Header() {
  return (
    <div className="sticky top-0 z-[20] mx-auto">
      <header className=" text-[#fff] flex items-ceneter gap-10 lg:gap-72 bg-[#09AB46] lg:px-4 px-2 h-20  ">
        <div className="md:pl-2 lg:pl-4 flex gap-2 lg:gap-4">
          ...
          />
          <p className="font-semibold text-lg lg:text-2xl mt-6">MI ARTISAN</p>
        </div>
        <NavLinks />
      </header>
    </div>
